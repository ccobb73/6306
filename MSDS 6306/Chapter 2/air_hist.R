...
plot(Temperature~Month,airquality, main="Temperature by Month", xlab="Month", ylab="Temperature")
...
plot(Ozone~Temperature,airquality,main='Temperature vs Ozone', xlab="Temperature",ylab="Ozone")
